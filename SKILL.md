---
name: colab-design
description: "Apply the official Colab design system to any deliverable, including a pixel poster, dither poster, or A4 poster. Use whenever work involves Colab branding, Colab presentations, research reports, usability-test findings decks, sales decks, slides, or documents, or when the user mentions Colab colors, Electric Green, Pine Green, Jade Green, the pixel or dither motif, the Advanced Presentation grid, or the colab. wordmark. Also use for Arabic, RTL, mirrored, or bilingual EN/AR Colab work — Alexandria typography, mirroring a deck, or right-to-left layout. Also use for Colab design tokens, Figma variables, variable modes, or the light / jade / dark / electric grounds — including making a slide readable on a different background. Colab is a bilingual EN/AR user experience research lab. Provides the full palette with contrast rules, type scale, the 8-column slide grid, 22 layout archetypes, the pixel/dither graphic language, component specs, a four-ground token system, and a measured Arabic/RTL build system."
metadata:
  version: "4.4.1"
---
...
- Electric Green floods take **Deep Jade** text (13.07:1), not Pine (9.49:1) and never white (1.34:1).
...
| Display | 280 | 240 | 200 | 160 | 120 | 60 | 40 | 24 | 20 | 16 |
|---|---|---|---|---|---|---|---|---|---|---|
| Line-height | ×0.90 at ≥100px · ×0.95 below |

**280 and 120 were added 2026-09-24** and built in the Figma file on 2026-09-25 as `Display/2XL` and `Display/S+` (see `references/token-system.md` §7). 120 is reserved for the Statement slide archetype; it does not fill the 60→160 chasm on ordinary slides (`references/editorial-technique.md` §0).
...
|---|---|---|---|---|
| Display headline | Display 160–280 | Bold/Black | White | Pine Green |
| Statement headline (full-bleed) | Display 120 | Bold/Black | White or Electric | Pine Green |

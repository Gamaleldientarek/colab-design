...
**280 and 120 were added 2026-09-24** and are specified, not yet in the Figma file: they are pending in `04 Typography` (see `references/token-system.md` §7). 120 is reserved for the Statement slide archetype; it does not fill the 60→160 chasm on ordinary slides (`references/editorial-technique.md` §0).

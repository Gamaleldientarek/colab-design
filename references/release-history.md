...
|---|---|---|---|---|
| [4.4.1](../CHANGELOG.md#441--2026-09-25) | 2026-09-25 | patch | `pending` | Figma sync: 38 text styles rebound off the deleted `numbers` collection, Display 280/120 built, counts updated to 518 |
| [4.4.0](../CHANGELOG.md#440--2026-09-24) | 2026-09-24 | minor | `d8abea5f48c3960e3046527eec50d0d3d69c0999` | Rendered EN/AR A4 posters, example slides for archetypes 15–22, design tokens (JSON/CSS/JS) with tests, the dither engine as a documented tool, Arabic copy review |

...
| # | Slide | Ground | Motif | Anatomy |
|---|---|---|---|---|
| **N3** | Stacked word column | Pine | none, or two static checker atoms per open **Q-9**: `[100,80,180,120]` top rail and `[100,840,180,120]` bottom rail, 9×6 cells at the 20px module, non-gradient `[M]` | prose column C1–C3 (x100, w620): paragraph 1 Body 24/1.35, pitch 38, **≤3 lines** `[100,320,620,114]` (the archetype's cap; the deck ran 6) · paragraph 2 Body 16/1.35, pitch 24, 3 lines `[100,600,620,72]` · word column C6–C8 (x1200, w620): word I ×3, Display 160 Black, 1 line, all-caps, tracking −2.5%, h116, pitch **220** at y **320 / 540 / 760**, Electric ink |
...
| # | Slide | Ground | Motif | Anatomy |
|---|---|---|---|---|
| **N8** | Metric card panel | White, Off-white header band | none, or a header-band field per open **Q-9**: `[1640,50,180,300,.20]`, the deck's own on-module field `[M]` | title T60 `[100,168,…]` · insight-card I ×3 at x **100 / 660 / 1220**, w500, y360–680 (three equal cards cannot sit on 8 column starts; 100/660 is the library's established 3-up pitch, as in #01 and #21) · numeral chip fill **Pine**, not Electric (pending Q-2) · card ground **Pine or Deep Jade**, not a per-topic hue (pending Q-3) · right lists at **x1420** (C7) · severity-list chip on the fixed severity scale, **Vivid Orange** for critical, not pink (pending Q-4) · caption ink `text/muted` (`#6C737F` on Light mode, see Q-4) or `#BCBEC0` |
...
| # | Slide | Ground | Motif | Anatomy |
|---|---|---|---|---|
| **N7** | Detail spread | Pine (rotates with Deep Jade across instances) | none (none in the deck `[M]`), or a shallow edge field per open **Q-9** | title T60 `[100,168,880,101]` · body Body 24 `[100,300,880,32]`, 1 line (28 is reserved for component internals, `editorial-technique.md` §2.10.1) · card I ×3 `[100,700,1060,204]`, spanning C1–C5 · right panel C6–C8 `[1200,50,620,890]`, stopping at the y940 content floor (the deck ran it to y1030, into the footer band): ground **Off-white**, icon **Pine** stroke 48px / 2.5, ≤1 line Body 24 **Pine** ink |

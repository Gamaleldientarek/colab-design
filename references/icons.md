...
```bash
curl -L -O "https://raw.githubusercontent.com/Gamaleldientarek/colab-design/main/assets/icons/stroke-rounded/arrow-right-02.svg"
```

The URL is a pure function of the icon name:

```text
https://raw.githubusercontent.com/Gamaleldientarek/colab-design/main/assets/icons/stroke-rounded/<icon-name>.svg
```
...
for i in arrow-down-01 arrow-left-02 arrow-right-02 square-arrow-move-left-up \
  ...
  curl -sL -O "https://raw.githubusercontent.com/Gamaleldientarek/colab-design/main/assets/icons/stroke-rounded/$i.svg"
done
```
